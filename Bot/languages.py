Languages = {
    ...
    'iw': 'hebrew', 'he': 'hebrew', 'hi': 'Hindi', 'hmn': 'hmong', 'hu': 'hungarian', 'is': 'icelandic', 'ig': 'igbo', 
    'id': 'indonesian', 'ga': 'irish', 'it': '🇮🇹 italian', 'ja': '🇯🇵 japanese', 'jw': 'javanese', 'kn': 'kannada', 'kk': '🇰🇿 kazakh', 
    'km': 'khmer', 'ko': '🇰🇷 korean', 'ku': 'kurdish (kurmanji)', 'ky': '🇰🇬 kyrgyz', 'lo': 'lao', 'la': 'latin', 'lv': 'latvian', 
    'lt': 'lithuanian', 'lb': 'luxembourgish', 'mk': 'macedonian', 'mg': 'malagasy', 'ms': 'malay', 'ml': 'malayalam', 'mt': 'maltese', 'mi': 'maori', 'mr': 'marathi', 
